...
Sub DoToolbar(ByVal hTbr As HWND,ByVal hInst As HINSTANCE)
	...
	Dim tbrbtn35 As TBBUTTON=(0,0,TBSTATE_ENABLED,TBSTYLE_SEP,{0,0},0)
	Dim tbrbtn34 As TBBUTTON=(15,IDM_MAKE_GO,TBSTATE_ENABLED,TBSTYLE_BUTTON,{0,0},0)
	Dim tbrbtn33 As TBBUTTON=(14,IDM_MAKE_RUN,TBSTATE_ENABLED,TBSTYLE_BUTTON,{0,0},0)
	Dim tbrbtn32 As TBBUTTON=(12,IDM_MAKE_COMPILE,TBSTATE_ENABLED,TBSTYLE_BUTTON,{0,0},0)
	Dim tbrbtn31 As TBBUTTON=(0,0,TBSTATE_ENABLED,TBSTYLE_SEP,{0,0},0)
	Dim tbrbtn30 As TBBUTTON=(23,IDM_VIEW_PROPERTY,TBSTATE_ENABLED,TBSTYLE_BUTTON Or TBSTYLE_CHECK,{0,0},0)
	Dim tbrbtn29 As TBBUTTON=(22,IDM_VIEW_PROJECT,TBSTATE_ENABLED,TBSTYLE_BUTTON Or TBSTYLE_CHECK,{0,0},0)
	...
	Dim tbrbtn20 As TBBUTTON=(18,IDM_EDIT_BOOKMARKPREVIOUS,TBSTATE_ENABLED,TBSTYLE_BUTTON,{0,0},0)
	Dim tbrbtn19 As TBBUTTON=(17,IDM_EDIT_BOOKMARKNEXT,TBSTATE_ENABLED,TBSTYLE_BUTTON,{0,0},0)
