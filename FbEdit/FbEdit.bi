...
Dim Shared ad As ADDINDATA=(1054)
...
Const C15=""
Const C16=""
Dim Shared sKeyWords(17) As String
...
Dim Shared kwcol As KWCOLOR=(RGB(0,0,128),RGB(0,0,128),RGB(0,0,128),RGB(64,64,0),RGB(128,0,0),RGB(0,0,128),RGB(0,0,128),RGB(0,0,128),RGB(0,0,128),&H1000000+RGB(0,0,128),&H4000000+RGB(0,0,128),RGB(0,0,128),RGB(0,0,128),RGB(0,0,128),RGB(0,0,128),RGB(0,0,128),&H1000000+RGB(0,255,255))
...
Dim Shared edtopt As EDITOPTION=(3,0,0,1,0,0,3,1,1,1,1,1,1,0,0,0,1)
Const sn = !"rsrc.bi\0                        "
