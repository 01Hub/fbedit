...
RestoreSourceByte proc uses ebx edi,lpLine:DWORD
	...
	mov		edi,lpLine
	.if edi
		mov		ebx,dbg.hMemNoBP
		add		ebx,[edi].DEBUGLINE.Address
		sub		ebx,dbg.minadr
		invoke WriteProcessMemory,dbg.hdbghand,[edi].DEBUGLINE.Address,ebx,1,0
	.endif
	ret
