...
START1:			DJNZ	R7,START2
                CLR		A						;Frequency counter channel 0
                AJMP	FREQENCYCOUNT
START2:			DJNZ	R7,START3				;Frequency counter channel 1
                MOV		A,#01h
START3:			DJNZ	R7,START4
                MOV		A,#02h					;Frequency counter channel 2
                AJMP	FREQENCYCOUNT
START4:			DJNZ	R7,START5
                MOV		A,#03h					;Frequency counter channel 3
                AJMP	FREQENCYCOUNT
START5:			DJNZ	R7,START6
                AJMP	ADCONVERTER				;AD Coverter
START6:			DJNZ	R7,START7
                AJMP	LMETER					;Inductance
START7:			AJMP	CMETER					;Capacitance
...
TERMINAL10:		CJNE	A,#52h,TERMINAL11
                ...
                ACALL	RUN
                SJMP	TERMINAL
TERMINAL11:		CJNE	A,#0Dh,TERMINAL2
                ;CR
                SJMP	TERMINAL1
...
ROMINSERT5:		ACALL	PRNTCSTR
                DB		' device and strike <Enter> ',00h
                ACALL	RXBYTE
                CJNE	A,#9Fh,ROMINSERT6	;Esc
                SETB	C
                RET
ROMINSERT6:		ACALL	PRNTCSTR
                DB		0Bh,2Ah,23h,'                                       '
                DB		0Dh,00h
                CLR		C
                RET

ROMWAIT:		ACALL	PRNTCSTR
...
CASB5:				MOV		B,#10
                    ...
                    MOV		B,#16				;HEX MODE
    ;
CASB6:				LCALL	MULNUM				;ACCUMULATE THE DIGITS
