...
;Get LC meter frquency F1 and F2. Calculatr LCCA and LCCB
;IN:	Nothing
;OUT:	Nothing
LCMETERINIT:	MOV	A,#40h				;D6 LC Meter	0=C, 1=L
							;D7 LC Meter	0=F1, 1=F2 (Adding C Cal)
		MOV	R1,#LOW LCF1
		MOV	R3,#HIGH LCF1
		LCALL	LCMETERGETFRQ			;Get F1
		MOV	A,#0C0h				;D6 LC Meter	0=C, 1=L
							;D7 LC Meter	0=F1, 1=F2 (Adding C Cal)
		MOV	R1,#LOW LCF2
		MOV	R3,#HIGH LCF2
		...
		;Calculate LCCB=((1/2*Pi*F1)^2)*LCCA
		MOV	DPTR,#FPTWO
		LCALL	PUSHC				; PUSH ARG IN DPTR TO STACK
		MOV	DPTR,#FPPI
		LCALL	PUSHC				; PUSH ARG IN DPTR TO STACK
...
ADCMUL:		DB 7Eh,00h,79h,07h,03h,52h		;CH0	1.6030779e-3
		DB 7Eh,00h,79h,07h,03h,16h		;CH1	1.6030779e-3
		DB 7Eh,00h,79h,00h,02h,36h		;CH2	1.6030779e-3
		DB 7Eh,00h,79h,07h,03h,16h		;CH3	1.6030779e-3

FPONE:		DB 80h,00h,00h,00h,00h,10h		;1.0000000
FPTWO:		DB 80h,00h,00h,00h,00h,20h		;2.0000000
...
START6:		DJNZ	R7,START7
		AJMP	ADCONVERTER			;AD Coverter External PSU
START7:		DJNZ	R7,START8
		AJMP	ADCONVERTER			;AD Coverter Internal PSU
START8:		DJNZ	R7,START9
		AJMP	LMETER				;Inductance
START9:		AJMP	CMETER				;Capacitance
...
;IN:	Nothing
;OUT:	Nothing
LMETER:		LCALL	LCMETERINIT
		AJMP	START

;Capacitance meter
;IN:	Nothing
;OUT:	Nothing
CMETER:		LCALL	LCMETERINIT
		AJMP	START
