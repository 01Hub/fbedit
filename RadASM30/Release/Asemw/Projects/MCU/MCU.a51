...
LMETER:		MOV	A,#000h				;D6 LC Meter	0=L, 1=C
		...
		MOV	R3,#HIGH LCF3
		LCALL	LCCALC
		;Calculate B=A*((F1/F2)^2)-1)*((1/(2*Pi*F1))^2)*(1/Ccal)
		MOV	R0,#LOW LCCB
		MOV	R2,#HIGH LCCB
		LCALL	PUSHAS				;PUSH R2:R0 TO ARGUMENT
		LCALL	FLOATING_MUL
...
FPCCAL:		DB 78h,00h,00h,00h,00h,10h		;1nF=1e-9
FPPF:		DB 8Dh,00h,00h,00h,00h,10h		;1e12
FPNF:		DB 8Ah,00h,00h,00h,00h,10h		;1e9
;------------------------------------------------------------------
