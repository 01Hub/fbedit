...
uint8_t wavestr[4][7]={{"Vmin  :"},{"Vmax  :"},{"Vpp   :"},{"Period:"}};
...
void WaveDrawInfo(void)
{
  ...
  /* Vmin */
  DrawWinString(WAVE_LEFT+4,WAVE_BOTTOM-50,7,wavestr[0],1);
  val=(Wave.min*Wave.fs)/4095;
  DrawWinDec32Fixed(WAVE_LEFT+4+8*8,WAVE_BOTTOM-50,val,1);
  /* Vmax */
  DrawWinString(WAVE_LEFT+4,WAVE_BOTTOM-40,7,wavestr[1],1);
  val=(Wave.max*Wave.fs)/4095;
  DrawWinDec32Fixed(WAVE_LEFT+4+8*8,WAVE_BOTTOM-40,val,1);
  /* Vpp */
  DrawWinString(WAVE_LEFT+4,WAVE_BOTTOM-30,7,wavestr[2],1);
  val=((Wave.max-Wave.min)*Wave.fs)/4095;
  ...
  DrawWinDec32(WAVE_LEFT+4+8*8,WAVE_BOTTOM-20,val,1);
}
