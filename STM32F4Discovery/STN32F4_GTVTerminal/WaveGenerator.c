    ...
    case EVENT_CHAR:
      if (param==0x0D)
      {
        switch (ID)
        {
          ...
          case 83:
          case 84:
            CheckGroup(Wave.hmain,80,84,ID);
            Wave.waveform=ID-80;
            WaveGetData();
            break;
          case 99:
