...
void WaveSetup(void)
{
  ...
  while (!Wave.Quit)
  {
    if (FrameCount & 1)
    {
      DrawDec16(0,240,DMA1_Stream6->NDTR,1);
      DrawDec16(50,240,TIM6->CNT,1);
      DrawDec16(100,240,DMA_GetFlagStatus(DMA1_Stream6,DMA_FLAG_TEIF6),1);
      DrawDec16(150,240,DMA_GetFlagStatus(DMA1_Stream6,DMA_FLAG_DMEIF6),1);
      DrawDec16(200,240,DMA_GetFlagStatus(DMA1_Stream6,DMA_FLAG_FEIF6),1);
      DrawDec16(250,240,DMA_GetCmdStatus(DMA1_Stream6),1);
    }
...
void WaveConfig()
{
  ...
  if (Wave.enable)
  {
    // /* DAC channel1 noise Configuration */
    ...
    // /* DAC channel1 triangle Configuration */
    // DAC_InitStructure.DAC_Trigger = DAC_Trigger_T6_TRGO;
    ...
    // DAC_SetChannel1Data(DAC_Align_12b_R, 0x0);
