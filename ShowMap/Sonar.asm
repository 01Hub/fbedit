...
Resize_Image proc hBmp:DWORD,wt:DWORD,ht:DWORD
	LOCAL	iwt:DWORD
	LOCAL	iht:DWORD
	LOCAL	image1:DWORD
	LOCAL	image2:DWORD
...
FindDepth:
	...
	.while ebx<32
		...
		.break .if eax>=sonardata.NoiseLevel
		inc		ebx
	.endw
